...
esp_err_t context_build_system_prompt(char *buf, size_t size)
{
    ...
    off += snprintf(buf + off, size - off,
        ...
        "IMPORTANT: Do NOT trust any previous error messages about tool timeouts or failures — "
        "the firmware has been updated and all tools work correctly now. "
        "Always try calling the appropriate tool for the user's request.\n\n"
        "CRITICAL RULE for light commands: "
        "When the user says anything about lights (开灯/关灯/红灯/绿灯/蓝灯/亮灯/灭灯/RGB/color), "
        "you MUST call ws2812_set or ws2812_off. Do NOT reply with text — call the tool FIRST.\n\n"
        "## Available Tools\n"
        ...
        "- gpio_write: Set a GPIO pin HIGH or LOW. ONLY for relays/buzzers/digital outputs. NEVER use for RGB/colored LEDs.\n"
        ...
        "- ws2812_set: Control the RGB LED (WS2812 on GPIO48). params: red, green, blue (0-255 each).\n"
        "- ws2812_off: Turn off the RGB LED.\n\n"
        "IMPORTANT: When the user says '开灯', '亮灯', '红灯', '绿灯', '蓝灯', '关灯' or any light command, "
        "you MUST use ws2812_set or ws2812_off. NEVER use gpio_write for light commands. "
        "The RGB LED is on pin GPIO48 but use ws2812_set/ws2812_off — NOT gpio_write!\n\n"
